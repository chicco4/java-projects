...
class FramePila extends Frame implements ActionListener, ItemListener {
    ...
    public FramePila(String string, Stack s) throws HeadlessException {
        super(string);
        this.s = s;
        ...
        this.lbl0 = new Label(s.empty() == false ? "" + this.s.peek() : "", CENTER);
        this.lbl1 = new Label(s.empty() == true ? "is Zero" : "", CENTER);
        //ci deve essere uno spazio
    ...
    public void itemStateChanged(ItemEvent ie) {
        ...
        this.lbl2.setText(s.get(i).toString());
    }
}
